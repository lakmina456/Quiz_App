...
public class MobileQuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //questionsAnswerMap = (HashMap<String, String>) Utils.getRandomMobileQuestions(Constants.QUESTION_SHOWING);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (answer.isEmpty()){
                    Toast.makeText(MobileQuizActivity.this, "Answer cannot be empty", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (btnNext.getText().equals(getString(R.string.next))){
                    ...
                    Intent intentResult = new Intent(MobileQuizActivity.this,FinalResultActivity.class);
                    intentResult.putExtra(Constants.SUBJECT,getString(R.string.MobileDevelop));
