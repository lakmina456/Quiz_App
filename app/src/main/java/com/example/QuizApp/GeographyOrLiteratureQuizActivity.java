...
public class GeographyOrLiteratureQuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (subject.equals(getString(R.string.literature))) {
            questionsAnswerMap = Utils.getOperational_ResearchAnd_InformationSystemsSecurityQuestions(this,getString(R.string.literature),Constants.QUESTION_SHOWING);
            tvTitle.setText(getString(R.string.literature_quiz));
        }else{
            questionsAnswerMap = Utils.getOperational_ResearchAnd_InformationSystemsSecurityQuestions(this,getString(R.string.geography),Constants.QUESTION_SHOWING);
